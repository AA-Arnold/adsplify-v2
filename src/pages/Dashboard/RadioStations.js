        ...
        return (
            <React.Fragment>
                ...
                <Col xl={12}>
                    <Row>
                        <Row>
                            <h1 className="card-title">Radio Stations</h1>
                            <footer className="blockquote-footer font-size-12" />
                        </Row>

                        <h1 className="card-title">View All<i class="ri-send-plane-2-line"></i> </h1>
                    </Row>
                    <p className="card-title-desc">Hire radio stations</p>
